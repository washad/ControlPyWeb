...
class ReaderWriter(AbstractReaderWriter):
    ...
    def read_immediate(self, addr: str, timeout: float = 0.5) -> object:
    ...
    def send_changes_to_module(self, timeout: float=1.0):
    ...
    def update_from_module(self, timeout: float = 1):
    ...
    def write_immediate(self, addr: str, value: object, timeout: float = 1.0):
        """
